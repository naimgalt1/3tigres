/* ═══════════════════════════════════════════════════
   3TIGRES BARBERSHOP — script.js
   i18n (ES/CA/EN) · menú móvil · reveal on-scroll · lightbox
   ═══════════════════════════════════════════════════ */
...
function openLightbox(item) {
  ...
  // Si el item contiene una <img>, mostramos la versión grande;
  // si es un placeholder, replicamos su estilo.
